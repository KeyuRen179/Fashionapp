        ...
        children=[
            html.Div(
                children=[
                    ...
                    html.Div(
                        children=[
                            dcc.Input(id='login_email', type='email', placeholder='Email', autoComplete='username', style={'marginBottom': '10px'}),
                            dcc.Input(id='login_password', type='password', placeholder='Password', autoComplete='current-password', style={'marginBottom': '10px'}),
                            html.Button('Login', id='login_submit', n_clicks=0, style={'marginRight': '10px'}),
                            dcc.Loading(
                                id="loading-login-feedback",
                                type="circle",
                                children=html.Div(id='login_feedback', style={'marginBottom': '10px'})
                            ),
                            dcc.Link('New here? Register', href='/register', style={'display': 'block', 'marginBottom': '5px'}),
                            dcc.Link('Forgot password?', href='/forgot-password', style={'display': 'block', 'marginBottom': '5px'}),
